          ...
          <CardContent className="p-6">
            ...
            <div className="mb-6">
              <div className="p-4 bg-gray-50 rounded-lg flex items-center justify-between">
                ...
                <button className="p-2 hover:bg-gray-200 rounded-full" onClick={copyWalletId}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 bg-black text-white p-3 rounded-lg hover:bg-gray-800">
                <Send className="w-4 h-4" />
                <span>Enviar</span>
              </button>
              <button className="flex items-center justify-center gap-2 border border-gray-200 p-3 rounded-lg hover:bg-gray-50">
